...
namespace HotelBooking.Infrastructure.Data.Migrations
{
    ...
    [Migration("20260320222744_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HotelBooking.Infrastructure.Data.Identity.Entities.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("HotelBooking.Infrastructure.Data.Identity.Entities.RefreshToken", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("HotelBooking.Infrastructure.Data.Identity.Entities.RefreshToken", b =>
                {
                    b.HasOne("HotelBooking.Infrastructure.Data.Identity.Entities.ApplicationUser", "User")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("HotelBooking.Infrastructure.Data.Identity.Entities.ApplicationUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
